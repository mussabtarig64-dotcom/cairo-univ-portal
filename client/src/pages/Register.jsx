...
export default function Register() {
  ...
  const inputClass =
    'w-full bg-slate-900/80 border border-slate-700 rounded-lg px-4 py-3 text-slate-100 text-sm focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all text-right placeholder:text-slate-500';
    ...
    <div className="w-full min-h-screen bg-[#0a101d] flex flex-col items-center justify-start py-8 px-4 sm:px-6 md:px-10 lg:px-12 overflow-x-hidden" dir="rtl">
      <div className="w-full max-w-4xl mx-auto box-border">
        ...
        <div className="text-center w-full mb-8">
          ...
          <p className="text-xs sm:text-sm text-slate-300 max-w-xl mx-auto px-2 leading-relaxed">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="bg-[#0B1221] border border-slate-700/60 rounded-2xl p-5 sm:p-8 md:p-10 shadow-2xl flex flex-col gap-8 w-full mx-auto box-border">
            ...
            <div className="w-full space-y-6">
              ...
              <div>
                <h2 className="text-amber-400 font-bold text-base sm:text-lg border-b border-slate-800 pb-2 mb-4 flex items-center gap-2">
            ...
            <div className="w-full flex flex-col gap-6">
              ...
              <div>
                <h2 className="text-amber-400 font-bold text-base sm:text-lg border-b border-slate-800 pb-2 mb-3 flex items-center gap-2">
              ...
              {/* Submit Action Area */}
              <div>
                <div className="flex items-start gap-2 p-3 bg-slate-900/60 border border-slate-800 rounded-xl text-xs text-slate-300 leading-relaxed">
