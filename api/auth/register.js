...
module.exports = async (req, res) => {
  ...
  res.setHeader(
    ...
    'X-CSRF-Token, X-Requested-With, Accept, Accept-Version, Content-Length, Content-MD5, Content-Type, Date, X-Api-Version, Authorization, Cache-Control, cache-control, Pragma, Expires'
  );
